				...
				<div class="section group">
					...
					<div class="col_1_of_3 span_1_of_3">
						...
						<div class="event-grid">
							<div class="event_img">
								<img src="<?=SITE_TEMPLATE_PATH ?>/assets/images/event1.jpg" title="post1" alt="">
							</div>
						...
						<div class="event-grid">
							<div class="event_img">
								<img src="<?=SITE_TEMPLATE_PATH ?>/assets/images/event2.jpg" title="post1" alt="">
							</div>
							<div class="event_desc">
								<h4>
						...
						<div class="event-grid">
							<div class="event_img">
								<img src="<?=SITE_TEMPLATE_PATH ?>/assets/images/event3.jpg" title="post1" alt="">
							</div>
							<div class="event_desc">
								<h4>
									<span>NEQUE LIGULA</span>
